...
pub static AUDIT_TABLE: &[FfiAuditEntry] = &[
    ...
    FfiAuditEntry {
        beam_module: "ridge_rt",
        fn_name: "time_to_micros",
        arity: 1,
        requires_caps: &[],
    },
    FfiAuditEntry {
        beam_module: "ridge_rt",
        fn_name: "time_from_micros",
        arity: 1,
        requires_caps: &[],
    },
    ...
    // ── ridge_rt time-of-day codec (std.timeofday) ─────────────────────────────
    FfiAuditEntry {
        beam_module: "ridge_rt",
        fn_name: "tod_from_hms",
        arity: 3,
        requires_caps: &[],
    },
    FfiAuditEntry {
    ...
    FfiAuditEntry {
        beam_module: "ridge_rt",
        fn_name: "list_sort_cmp",
        arity: 2,
        requires_caps: &[],
    },
    FfiAuditEntry {
        beam_module: "ridge_rt",
        fn_name: "ord_compare_native",
        arity: 2,
        requires_caps: &[],
    },
    FfiAuditEntry {
